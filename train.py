...
from nearest_neighbours import find_neighbours
from classifier import GaussianKernels
from image_loader import MultiFolderLoader
...
parser.add_argument("--max_epochs", default=30, type=int, help="Maximum training length (epochs).")
...
train_dataset  = MultiFolderLoader(args.data_dir, train_transforms, num_classes = args.num_classes, start_indx = 0, img_type = "."+args.im_ext)
update_dataset = MultiFolderLoader(args.data_dir, update_transforms, num_classes = args.num_classes, start_indx = 0, img_type = "."+args.im_ext)
